...
/* End of the Flash address */// 0x080FFFFF
#define USER_FLASH_END_ADDRESS        0x08080000//app程序flash结束地址
/* Define the user application size */
#define USER_FLASH_SIZE   (USER_FLASH_END_ADDRESS - APPLICATION_ADDRESS + 1) //app程序flash大小

/* Define the address from where user application will be loaded.
   Note: the 1st sector 0x08000000-0x08003FFF is reserved for the IAP code */
#define APPLICATION_ADDRESS   (uint32_t)0x08040000 //flash起始地址
